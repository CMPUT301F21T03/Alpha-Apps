 ...
 *
 * Description: Will listen for changes in the location of the user, and when called, will give the
 * location in terms of a latitude and longitude
 *
 * Changelog:
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                // no network provider is enabled so the location is not retrieved
            } else {
